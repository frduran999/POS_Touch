...
Public Class RPT_Ventas_X_Usuario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Ventas_X_Usuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RPT_Ventas_X_Usuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Ventas_X_Usuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Ventas_X_Usuario = New RPT_Ventas_X_Usuario()
        rpt.Site = Me.Site
        Return rpt
    End Function
