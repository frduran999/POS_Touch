...
Public Class RptTicketFamilia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RptTicketFamilia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTicketFamilia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTicketFamilia = New RptTicketFamilia()
        rpt.Site = Me.Site
        Return rpt
    End Function
